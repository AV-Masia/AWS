...
/**
 * OTP REST-провайдер для Korzinka.
 * Эндпоинты:
 *   POST /realms/{realm}/otp/send   {"phoneNumber": "..."}
 *   POST /realms/{realm}/otp/verify {"phoneNumber": "...", "code": "..."}
 */
public class KorzinkaOtpResourceProvider implements RealmResourceProvider {

    private static final Logger LOG = Logger.getLogger(KorzinkaOtpResourceProvider.class);
    ...
    KorzinkaOtpResourceProvider(KeycloakSession session) {
