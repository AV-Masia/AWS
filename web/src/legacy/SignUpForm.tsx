  ...
  if (stage === 'done') {
    return (
      <section>
        ...
        <p className="muted">
          Адрес подтверждён кодом из письма. Теперь этим пользователем можно войти на вкладке
          «Вход через миграцию» — он уже в Cognito, старая база для него не при чём.
        </p>
      </section>
    )
  }
